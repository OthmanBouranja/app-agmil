...
class Sync_model extends CI_Model
{
        ...
        if ($billers) {
            ...
            if (isset($ids)) {
                ...
                foreach ($ids as $id) {
                    ...
                    $this->db->update('factures', ['biller_id' => $id['new']], ['biller_id' => $id['old']]);
                }
            }
            return true;
        }
        ...
        if ($customers) {
            ...
            if (isset($ids)) {
                ...
                foreach ($ids as $id) {
                    ...
                    $this->db->update('factures', ['customer_id' => $id['new']], ['customer_id' => $id['old']]);
                }
            }
            return true;
        }
    ...
    public function resetFacturesTable()
    {
        $this->db->truncate('factures');
        $this->db->truncate('facture_items');
        return true;
    }
    ...
    public function resetDevisTable()
    {
        $this->db->truncate('Devis');
        $this->db->truncate('Devis_items');
        return true;
    }
    ...
    {
        $this->db->query('UPDATE ' . $this->db->dbprefix('devis') . " SET status='completed'");
        return true;
    }
    
    public function updateFactures()
    {
        $this->db->query('UPDATE ' . $this->db->dbprefix('factures') . " SET status='completed'");
        return true;
    }
