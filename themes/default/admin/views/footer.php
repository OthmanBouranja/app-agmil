...
<?= ($m == 'factures' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/factures.js"></script>' : ''; ?>
<?= ($m == 'devis' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/devis.js"></script>' : ''; ?>
<?= ($m == 'customers' && ($v == 'add' || $v == 'edit'|| $v == 'index')) ? '<script type="text/javascript" src="' . $assets . 'js/customer.js"></script>' : ''; ?>
