...
<script type="text/javascript">
    ...
    ?>
        ...
        localStorage.setItem('quitems', JSON.stringify(<?= $devis_items; ?>));
        localStorage.setItem('qucustomer', '<?= $devis->customer_id ?>');
        localStorage.setItem('qunote', '<?= str_replace(["\r", "\n"], '', $this->sma->decode_html($devis->note)); ?>');

        localStorage.setItem('qusupplier', '<?= $devis->supplier_id ?>');
        localStorage.setItem('qubiller', '<?= $devis->biller_id ?>');
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php if ($devis_id) { ?>
                    <input name="devis" type="hidden" value="<?= $devis_id;?>" />
                <?php } ?>
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php if ($devis_id) { ?>
                                    <?php echo form_input('reference_no', ($_POST['reference_no'] ?? $qunumber), 'class="form-control input-tip" id="quref"'); ?>
                                <?php } else{?>
                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <?= lang("Companie d'assurance", 'quassurance'); ?>
                                <input type="text" name="quassurance" value="" id="quassurance" class="form-control">
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group">
                                <?= lang("Courtier d'assurance", 'qucourtier'); ?>
                                <input type="text" name="qucourtier" value="" id="qucourtier" class="form-control">
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group">
                                <?= lang("N° Sinistre", 'qusinistre'); ?>
                                <input type="text" name="qusinistre" value="" id="qusinistre" class="form-control">
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="form-group">
                                <?= lang('Kilométrage du Véhicule', 'qunote'); ?>
                                <input type="text" name="note" value="<?=  (isset($_POST['note']) ? $_POST['note'] : '') ?>" id="qunote" class="form-control">
                            </div>
                        </div>
