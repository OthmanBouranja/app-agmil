    ...
    <script>
        $(document).ready(function () {
            oTable = $('#QUData').dataTable({
                ...
                "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, null,{"mRender": deadLineStatus}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}]
                ...
                {column_number: 6, filter_default_label: "[Deadline]", filter_type: "text", data: []},
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="small-box padding1010 col-sm-4 borange">
                        <h3> <?= $userReportSynthesis['0']['count']; ?> </h3>
                        <p class="bold">En instance</p>
                    </div>
                    <div class="small-box padding1010 col-sm-4 blightOrange">
                        <h3> <?= $userReportSynthesis['1']['count']; ?> </h3>
                        <p>En production</p>
                    </div>
                    <div class="small-box padding1010 col-sm-4 bdarkGreen">
                        <h3> <?= $userReportSynthesis['2']['count']; ?> </h3>
                        <p>Terminer</p>
                    </div>
