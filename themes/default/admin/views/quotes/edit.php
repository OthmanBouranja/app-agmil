...
<script type="text/javascript">
    ...
    ?>
        ...
        localStorage.setItem('quassurance', '<?=$inv->quassurance?>');
        localStorage.setItem('qucourtier', '<?=$inv->qucourtier?>');
        localStorage.setItem('qusinistre', '<?=$inv->qusinistre?>');
        localStorage.setItem('qustatus', '<?=$inv->status?>');
        localStorage.setItem('qunote', '<?= $inv->note; ?>');
