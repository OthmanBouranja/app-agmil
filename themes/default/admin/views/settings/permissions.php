                            ...
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" id="sales-pdf_beta" class="checkbox" name="sales-pdf_beta" <?php echo $p->{'sales-pdf_beta'} ? 'checked' : ''; ?>>
                                            <label for="sales-pdf_beta" class="padding05"><?= lang('Proforma') ?></label>
                                        </span>
                                        <span style="display:inline-block;">
                                            <?php if (POS) {
            ?>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td><?= lang('Factures'); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="factures-index" <?php echo $p->{'factures-index'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="factures-add" <?php echo $p->{'factures-add'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="factures-edit" <?php echo $p->{'factures-edit'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="factures-delete" <?php echo $p->{'factures-delete'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td>
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" id="factures-email" class="checkbox" name="factures-email" <?php echo $p->{'factures-email'} ? 'checked' : ''; ?>>
                                            <label for="factures-email" class="padding05"><?= lang('email') ?></label>
                                        </span>
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" id="factures-pdf" class="checkbox" name="factures-pdf" <?php echo $p->{'factures-pdf'} ? 'checked' : ''; ?>>
                                            <label for="factures-pdf" class="padding05"><?= lang('pdf') ?></label>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td><?= lang('devis'); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="devis-index" <?php echo $p->{'devis-index'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="devis-add" <?php echo $p->{'devis-add'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="devis-edit" <?php echo $p->{'devis-edit'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="devis-delete" <?php echo $p->{'devis-delete'} ? 'checked' : ''; ?>>
                                    </td>
                                    <td>
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" id="devis-email" class="checkbox" name="devis-email" <?php echo $p->{'devis-email'} ? 'checked' : ''; ?>>
                                            <label for="devis-email" class="padding05"><?= lang('email') ?></label>
                                        </span>
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" id="devis-pdf" class="checkbox" name="devis-pdf" <?php echo $p->{'devis-pdf'} ? 'checked' : ''; ?>>
                                            <label for="devis-pdf" class="padding05"><?= lang('pdf') ?></label>
                                        </span>
                                    </td>
                                </tr>
