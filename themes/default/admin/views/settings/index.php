            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="facture_prefix"><?= lang("facture_prefix"); ?></label>

                                <?= form_input('facture_prefix', $Settings->facture_prefix, 'class="form-control tip" id="facture_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="devis_prefix"><?= lang("Devis_prefix"); ?></label>

                                <?= form_input('devis_prefix', $Settings->devis_prefix, 'class="form-control tip" id="devis_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
