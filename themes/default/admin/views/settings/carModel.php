...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getCarModels') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i>Modèles</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('system_settings/add_carModel'); ?>" data-toggle="modal" data-target="#myModal">
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> Supprimer le modèle
                            </a>
                        </li>
                    </ul>
                </li>
