                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row" id="bt">
                            <div class="col-sm-12">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <?= lang('Kilométrage du Véhicule :', 'dvnote'); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="mcode" class="col-sm-4 control-label"><?= lang('Référence') ?> *</label>
                    ...
                    <div class="form-group">
                        <label for="mname" class="col-sm-4 control-label"><?= lang('Désignation Produit') ?> *</label>
