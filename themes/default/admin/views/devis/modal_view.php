...
<div class="modal-dialog modal-lg no-modal-header">
    ...
    ?>
            ...
            <div class="row" style="margin-bottom:15px;">
                <div class="col-xs-6">
                    <?php echo $this->lang->line('Devis pour Véhicule N° '); ?>:<br/>
            ...
            <?php if (!$Supplier || !$Customer) {
                ...
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('devis/email/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal2" class="tip btn btn-primary" title="<?= lang('email') ?>">
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('devis/edit/' . $inv->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
