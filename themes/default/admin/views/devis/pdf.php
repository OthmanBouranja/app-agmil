...
<head>
    ...
    <title><?= $this->lang->line('Devis') . ' ' . $inv->reference_no; ?></title>
...
<div id="wrap">
    ...
    <div class="row">
        <div class="col-xs-5 bold text-center" >
            <p style="font-size: 30px;">DEVIS</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-xs-7" style="margin-top: 15px;">
            <div style="padding:5px; background-color:#FFFFFF; border:1px solid black; -moz-border-radius:9px; -khtml-border-radius:9px; -webkit-border-radius:9px; border-radius:9px;">
                ...
                <table style="width: 100%;" class="small-font">
                    ...
                    <tr>
                        <td style="padding: 0 50px 0 10px; "><span class="bold">Devis N°</span> : <?= $inv->reference_no; ?> </td>
        ...
        <div class="col-lg-12" style="display: none;">
            ...
            <div class="padding10">
                ...
                <div class="col-xs-5">
                    <br></br>
                    <br></br>
                    <h2 style="font-size:40px; color:#AFAFAF" class="">DEVIS</h2>
                    <p></p>
