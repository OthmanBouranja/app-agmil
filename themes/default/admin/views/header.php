                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_devis">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('Devis'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="devis_index">
                                        <a class="submenu" href="<?= admin_url('devis'); ?>">
                                            <i class="fa fa-heart-o"></i>
                                            <span class="text"> <?= lang('Liste_Devis'); ?></span>
                                        </a>
                                    </li>
                                    <li id="devis_add">
                                        <a class="submenu" href="<?= admin_url('devis/add'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_devis'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('Bon de Livraison'); ?>
                                ...
                                <ul>
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= admin_url('sales'); ?>">
                                            <i class="fa fa-heart"></i>
                                            <span class="text"> <?= lang('Liste BL'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="sales_add">
                                        <a class="submenu" href="<?= admin_url('sales/add'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('Ajouter BL'); ?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_factures">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-heart-o"></i>
                                    <span class="text"> <?= lang('Factures'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="factures_index">
                                        <a class="submenu" href="<?= admin_url('factures'); ?>">
                                            <i class="fa fa-heart-o"></i>
                                            <span class="text"> <?= lang('Liste Facture'); ?></span>
                                        </a>
                                    </li>
                                    <li id="factures_add">
                                        <a class="submenu" href="<?= admin_url('factures/add'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('Ajouter Facture'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                ?>
                                    ...
                                    <li id="system_settings_categories">
                                        <a href="<?= admin_url('system_settings/carBrand') ?>">
                                            <i class="fa fa-folder-open"></i><span class="text">Marques Véhicule</span>
                                        </a>
                                    </li>

                                    <li id="system_settings_categories">
                                        <a href="<?= admin_url('system_settings/customerCard') ?>">
                                            <i class="fa fa-folder-open"></i><span class="text">Fiches client</span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_devis">
                                ...
                                <ul>
                                    <li id="devis_add">
                                        <a class="submenu" href="<?= admin_url('controle/controle'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text">List Ficher Controle</span>
                                        </a>
                                    </li>
                                    <li id="devis_index">
                                        <a class="submenu" href="<?= admin_url('controle/add_controle'); ?>">
                                            <i class="fa fa-heart-o"></i>
                                            <span class="text">Créer un Controle </span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
...
<?php if ($GP['devis-index'] || $GP['devis-add']) {
                            ?>
                            <li class="mm_devis">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-heart-o"></i>
                                ...
                                <ul>
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= admin_url('devis'); ?>">
                                            <i class="fa fa-heart-o"></i><span class="text"> <?= lang('Liste Devis'); ?></span>
                                        </a>
                                    </li>
                                    <?php if ($GP['devis-add']) {
                                ?>
                                    <li id="sales_add">
                                        <a class="submenu" href="<?= admin_url('devis/add'); ?>">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_devis'); ?></span>
                                        </a>
                                    </li>
                                    <?php
                            } ?>
