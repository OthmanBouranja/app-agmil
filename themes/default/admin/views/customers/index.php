...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            {column_number: 7, filter_default_label: "[<?=lang('N째 Carte grise	');?>]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('N째 ICE');?>]", filter_type: "text", data: []},
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('customers/add'); ?>" id="add">
