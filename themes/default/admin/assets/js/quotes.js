$(document).ready(function () {
    ...
    if ((quassurance = localStorage.getItem('quassurance'))) {
        $('#quassurance').val(quassurance);
    }
    if ((qucourtier = localStorage.getItem('qucourtier'))) {
        $('#qucourtier').val(qucourtier);
    }
    if ((qusinistre = localStorage.getItem('qusinistre'))) {
        $('#qusinistre').val(qusinistre);
    }
    ...
    $('#reset').click(function (e) {
        bootbox.confirm(lang.r_u_sure, function (result) {
            if (result) {
                ...
                if (localStorage.getItem('quassurance')) {
                    localStorage.removeItem('quassurance');
                }
                if (localStorage.getItem('qucourtier')) {
                    localStorage.removeItem('qucourtier');
                }
                if (localStorage.getItem('qusinistre')) {
                    localStorage.removeItem('qusinistre');
                }
